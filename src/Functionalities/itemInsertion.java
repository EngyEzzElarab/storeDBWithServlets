...
public class itemInsertion {
			...
			public static void insertNewItem(Connection connection, int id , String Author , String Manufacturer, Double  Width , Double Height , int KItId  ) throws SQLException
			{
