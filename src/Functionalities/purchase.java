								...
								while(result.next() && remainingAmount>0)
								{
									...
									int transAmount=0;
											...
											if(quantityAtStore>=remainingAmount)
													{
														// UPDATE ItemSToreRElation SET Quantity=quantityAtStore-amount WHERE StoreID=storeID
															...
															//System.out.println("The item has been purchased from one store successfully");
															//    INSERT INTO Transactions(cID,ItemID,StoreID,Amount,transTime,transDate) VALUES(1,1,1,2,now(),'2022-08-15');
											...
											else
													{
														   ...
														   // preparedStatement.setInt(1, 0);
															...
															//System.out.println("The item will  be purchased from more than one store");
													}
